...
import { Printer, Archive, ListOrdered, BarChart3, Cloud, Settings, Sun, Moon, Monitor, ChevronLeft, ChevronRight, Keyboard, Github, ArrowUpCircle, Wrench, FolderKanban, FolderOpen, X, Menu, Info, Plug, Bug, LogOut, Key, Loader2, Disc3, ShieldAlert, Globe, Bell, Receipt, WandSparkles, ListTodo, type LucideIcon } from 'lucide-react';
...
export const defaultNavItems: NavItem[] = [
  ...
  { id: 'creator', to: '/creator', icon: WandSparkles, labelKey: 'nav.creator' },
  { id: 'bca-tasks', to: '/tasks', icon: ListTodo, labelKey: 'nav.bcaTasks' },
  { id: 'bca-config', to: '/creator/settings', icon: Key, labelKey: 'nav.bcaConfig' },
...
export function Layout() {
  ...
  const orderedSidebarIds = (() => {
    ...
    const navPermissions: Record<string, Permission | Permission[]> = {
      ...
      creator: 'queue:create',
      'bca-tasks': 'queue:read_all',
      'bca-config': 'settings:update',
