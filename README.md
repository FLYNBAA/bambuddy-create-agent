...
> [!NOTE]
> **BCA integration / BCA 集成说明** — This repository includes Bambuddy Create Agent, the embedded self-hosted 3D-creation workflow and calibrated-3MF task handoff. See the bilingual [BCA README / BCA 中英文说明](README_BCA.md), [architecture](BCA_ARCHITECTURE.md), and [deployment guide](DEPLOYMENT_BCA.md).
