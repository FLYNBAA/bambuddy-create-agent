...
async def run_migrations(conn):
    ...
    # BCA task lifecycle: the first BCA preview stored only a source/sliced
    # file link. The queue-item link lets the task list hand off to Bambuddy's
    # native queue without losing the permanent task/audit relationship.
    await _safe_execute(
        conn,
