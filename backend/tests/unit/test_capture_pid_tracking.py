...
class TestCleanupExcludesCapturePids:
    ...
    async def test_cleanup_kills_non_capture_pids(self):
        ...
        # 43000 should have been killed with the strongest signal available.
        force_signal = getattr(signal, "SIGKILL", signal.SIGTERM)
        mock_kill.assert_any_call(43000, force_signal)

        # 42000 should never have been targeted by orphan cleanup.
        killed_pids = [call[0][0] for call in mock_kill.call_args_list if call[0][1] == force_signal]
